...
torchrun --standalone --nproc_per_node=1 experiments/exp157_exp83_proven_lr3_ema_maxspeed/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp157_exp83_proven_lr3_ema_maxspeed \
