    ...
    for step in range(args.num_iterations + 1):
        ...
        if args.val_loss_every > 0 and (step % args.val_loss_every == 0 or last_step):
            ...
            if last_step:
                ...
                val_loss = min(val_loss_ema.item() if isinstance(val_loss_ema, torch.Tensor) else val_loss_ema,
                               val_loss_raw.item() if isinstance(val_loss_raw, torch.Tensor) else val_loss_raw)
