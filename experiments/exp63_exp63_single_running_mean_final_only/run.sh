...
torchrun --standalone --nproc_per_node=1 experiments/exp63_exp63_single_running_mean_final_only/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp63_exp63_single_running_mean_final_only \
