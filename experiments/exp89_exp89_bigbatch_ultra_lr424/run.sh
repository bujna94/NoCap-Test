...
torchrun --standalone --nproc_per_node=1 experiments/exp89_exp89_bigbatch_ultra_lr424/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp89_exp89_bigbatch_ultra_lr424 \
