...
torchrun --standalone --nproc_per_node=1 experiments/exp105_exp105_maxspeed_b64_vocabpad_lr3_ema/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp105_exp105_maxspeed_b64_vocabpad_lr3_ema \
