...
torchrun --standalone --nproc_per_node=1 experiments/exp40_exp40_multi_candidate_weight_avg/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp40_exp40_multi_candidate_weight_avg \
