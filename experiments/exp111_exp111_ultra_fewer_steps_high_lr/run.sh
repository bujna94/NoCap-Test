...
torchrun --standalone --nproc_per_node=1 experiments/exp111_exp111_ultra_fewer_steps_high_lr/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp111_exp111_ultra_fewer_steps_high_lr \
