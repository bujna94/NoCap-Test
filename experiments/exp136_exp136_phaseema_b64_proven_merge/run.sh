...
torchrun --standalone --nproc_per_node=1 experiments/exp136_exp136_phaseema_b64_proven_merge/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp136_exp136_phaseema_b64_proven_merge \
