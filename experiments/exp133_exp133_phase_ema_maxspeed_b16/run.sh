...
torchrun --standalone --nproc_per_node=1 experiments/exp133_exp133_phase_ema_maxspeed_b16/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp133_exp133_phase_ema_maxspeed_b16 \
