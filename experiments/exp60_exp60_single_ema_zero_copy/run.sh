...
torchrun --standalone --nproc_per_node=1 experiments/exp60_exp60_single_ema_zero_copy/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp60_exp60_single_ema_zero_copy \
