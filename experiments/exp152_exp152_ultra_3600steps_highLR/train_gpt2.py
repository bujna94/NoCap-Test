...
if __name__ == "__main__":
    ...
    # --- ULTRA CONFIG ---
    # Use fewer steps (3600 instead of ~5100) with higher LR to compensate
    TOTAL_STEPS = 3600
    PEAK_LR = 0.0042
    WARMUP_STEPS = 200
    WARMDOWN_STEPS = 900  # 25% warmdown for smooth convergence

    # Override num_iterations
    args.num_iterations = TOTAL_STEPS
    ...
    model_config = {
        "d12": GPTConfig(vocab_size=50304, n_layer=12, n_head=12, n_embd=768),
        "d24": GPTConfig(vocab_size=50304, n_layer=24, n_head=16, n_embd=1024),
        "d36": GPTConfig(vocab_size=50304, n_layer=36, n_head=20, n_embd=1280),
        "d48": GPTConfig(vocab_size=50304, n_layer=48, n_head=25, n_embd=1600),
    }[args.model]
    ...
    for step in range(args.num_iterations + 1):
        ...
        if do_val:
            ...
            if last_step:
                ...
                for p, rp in zip(raw_model.parameters(), raw_params):
                    p.data = rp
        ...
        in_warmdown = step >= (args.num_iterations - WARMDOWN_STEPS)
        ema_decay = EMA_DECAY_WARMDOWN if in_warmdown else EMA_DECAY_CONSTANT
