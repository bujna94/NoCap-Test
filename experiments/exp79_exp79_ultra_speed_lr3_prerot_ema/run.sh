...
torchrun --standalone --nproc_per_node=1 experiments/exp79_exp79_ultra_speed_lr3_prerot_ema/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp79_exp79_ultra_speed_lr3_prerot_ema \
