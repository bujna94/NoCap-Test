...
torchrun --standalone --nproc_per_node=1 experiments/exp100_exp100_paired_kv_share_real/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp100_exp100_paired_kv_share_real \
