...
torchrun --standalone --nproc_per_node=1 experiments/exp71_exp71_fast_val_ema_fullgraph/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp71_exp71_fast_val_ema_fullgraph \
