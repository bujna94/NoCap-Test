...
if __name__ == "__main__":
    ...
    original_B = args.batch_size
    original_grad_accum = args.grad_accumulation_steps
    if EFFECTIVE_BATCH > original_B and (original_B * original_grad_accum) % EFFECTIVE_BATCH == 0:
        new_grad_accum = (original_B * original_grad_accum) // EFFECTIVE_BATCH
        if new_grad_accum >= 1:
            B = EFFECTIVE_BATCH
            args.grad_accumulation_steps = new_grad_accum
            args.batch_size = B
        else:
            B = original_B
    else:
