...
torchrun --standalone --nproc_per_node=1 experiments/exp142_exp142_b64_gradclip_phaseema_lr003/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp142_exp142_b64_gradclip_phaseema_lr003 \
