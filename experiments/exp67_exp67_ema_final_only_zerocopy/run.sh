...
torchrun --standalone --nproc_per_node=1 experiments/exp67_exp67_ema_final_only_zerocopy/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp67_exp67_ema_final_only_zerocopy \
