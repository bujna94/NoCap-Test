...
if __name__ == "__main__":
    ...
    model_params_list = list(raw_model.parameters())
    ...
    for step in range(args.num_iterations + 1):
        ...
        if args.val_loss_every > 0 and (step % args.val_loss_every == 0 or last_step):
            ...
            if last_step:
                ...
                for p, ema_p in zip(model_params_list, ema_params):
                    p.data, ema_p.data = ema_p.data, p.data
        ...
        with torch.no_grad():
            for ema_p, p in zip(ema_params, model_params_list):
