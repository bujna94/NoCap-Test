...
if __name__ == "__main__":
    ...
    optimizer = raw_model.configure_optimizers(
        ...
        learning_rate=OVERRIDE_PEAK_LR,
        betas=(0.9, 0.95),
        device_type=device,
    )
    ...
    def get_lr(it):
        ...
        if it < args.warmup_iters:
            return OVERRIDE_PEAK_LR * (it + 1) / args.warmup_iters
        elif it < args.num_iterations - args.warmdown_iters:
            return OVERRIDE_PEAK_LR
        else:
            decay_ratio = (args.num_iterations - it) / args.warmdown_iters
            return OVERRIDE_PEAK_LR * decay_ratio
        ...
        if args.val_loss_every > 0 and (step % args.val_loss_every == 0 or last_step):
            ...
            if last_step:
                ...
                for p, ema_p in zip(raw_model.parameters(), ema_params):
                    raw_params_backup.append(p.data)
                    p.data = ema_p
