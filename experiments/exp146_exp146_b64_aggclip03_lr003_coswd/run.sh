...
torchrun --standalone --nproc_per_node=1 experiments/exp146_exp146_b64_aggclip03_lr003_coswd/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp146_exp146_b64_aggclip03_lr003_coswd \
