...
torchrun --standalone --nproc_per_node=1 experiments/exp117_exp117_ultra_aggressive_b96_lr004/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp117_exp117_ultra_aggressive_b96_lr004 \
