...
EMA_DECAY = 0.9995
EMA_START_STEP = 2384  # Start EMA accumulation halfway through training
...
if __name__ == "__main__":
    ...
    # ---- EMA setup ----
    # We store EMA shadow weights as a flat list of tensors (not on the model)
    # Only initialize after EMA_START_STEP to save memory during early training
    ...
    for step in range(args.num_iterations + 1):
        ...
        if step >= EMA_START_STEP:
            if not ema_initialized:
                # Initialize EMA with current parameters
