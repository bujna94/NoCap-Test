...
PEAK_LR = 0.003          # proven in exp72/85
WARMUP_STEPS = 256
WARMDOWN_STEPS = 1024
LR_FLOOR_FRAC = 0.05     # conservative: floor LR at 5% of peak during warmdown
EMA_DECAY = 0.998        # proven
INTERMEDIATE_VAL_BATCHES = 4  # reduced for speed
...
if __name__ == "__main__":
    ...
    def get_lr(it):
        ...
        if it < WARMUP_STEPS:
            ...
            lr_min = LR_FLOOR_FRAC * PEAK_LR
            return lr_min + (PEAK_LR - lr_min) * decay_ratio
