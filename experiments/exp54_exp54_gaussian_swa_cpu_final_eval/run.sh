...
torchrun --standalone --nproc_per_node=1 experiments/exp54_exp54_gaussian_swa_cpu_final_eval/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp54_exp54_gaussian_swa_cpu_final_eval \
