...
if __name__ == "__main__":
    ...
    parser.add_argument("--learning_rate", type=float, default=PEAK_LR)
    ...
    print0(f"total tokens: {tokens_per_iter * args.num_iterations:,}")
    ...
    def get_lr(it):
        ...
        if it < args.warmup_iters:
            ...
            # cosine decay in warmdown for smoother convergence
