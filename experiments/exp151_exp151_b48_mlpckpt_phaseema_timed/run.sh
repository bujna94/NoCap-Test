...
torchrun --standalone --nproc_per_node=1 experiments/exp151_exp151_b48_mlpckpt_phaseema_timed/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp151_exp151_b48_mlpckpt_phaseema_timed \
