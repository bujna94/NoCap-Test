...
torchrun --standalone --nproc_per_node=1 experiments/exp51_exp51_sqrt_warmdown_minimal_swa/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp51_exp51_sqrt_warmdown_minimal_swa \
