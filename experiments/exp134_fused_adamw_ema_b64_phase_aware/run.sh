...
torchrun --standalone --nproc_per_node=1 experiments/exp134_fused_adamw_ema_b64_phase_aware/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp134_fused_adamw_ema_b64_phase_aware \
