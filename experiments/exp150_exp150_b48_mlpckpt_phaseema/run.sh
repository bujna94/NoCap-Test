...
torchrun --standalone --nproc_per_node=1 experiments/exp150_exp150_b48_mlpckpt_phaseema/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp150_exp150_b48_mlpckpt_phaseema \
