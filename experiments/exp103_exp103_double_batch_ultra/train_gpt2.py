...
EMA_DECAY = 0.998
MICRO_BATCH = 64
GRAD_ACCUM_OVERRIDE = 2  # per-GPU grad accum; total tokens/step = 64*1024*8*2 = 1,048,576
...
if __name__ == "__main__":
    ...
    # Force grad_accumulation to GRAD_ACCUM_OVERRIDE per GPU
    ...
    print0(f"micro_batch: {B}, grad_accum_steps (per gpu): {grad_accumulation_steps}")
    print0(f"num_iterations: {args.num_iterations}, warmup: {WARMUP_STEPS}, warmdown: {WARMDOWN_STEPS}")
