...
torchrun --standalone --nproc_per_node=1 experiments/exp148_exp148_cyclic_lr_phase_ema_ultra/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp148_exp148_cyclic_lr_phase_ema_ultra \
