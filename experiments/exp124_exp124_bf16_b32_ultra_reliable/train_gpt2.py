...
if __name__ == "__main__":
    ...
    # Maintain same total tokens per step as original
    original_total_batch = args.batch_size * args.grad_accumulation_steps
    new_total_grad_accum = max(1, original_total_batch // B)
    if ddp_world_size > 1:
    ...
    for step in range(args.num_iterations + 1):
        ...
        if args.val_loss_every > 0 and (step % args.val_loss_every == 0 or last_step):
            ...
            if is_final:
                ...
                for p, real_p in zip(raw_model.parameters(), real_params):
                    p.data = real_p
