...
torchrun --standalone --nproc_per_node=1 experiments/exp138_exp138_b64_gradclip_lr003_phaseema/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp138_exp138_b64_gradclip_lr003_phaseema \
