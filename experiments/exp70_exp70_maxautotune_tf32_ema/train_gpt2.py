...
class Rotary(torch.nn.Module):
    ...
    def forward(self, x):
        ...
        return self.cos_cached[None, :, None, :].clone(), self.sin_cached[None, :, None, :].clone()
...
if __name__ == "__main__":
    ...
    print0("compiling the model with max-autotune...")
    ...
    for step in range(args.num_iterations + 1):
        ...
        # Only sync every 10 steps for logging to reduce overhead
