...
if __name__ == "__main__":
    ...
    parser.add_argument("--warmdown_iters", type=int, default=1280)
    ...
    # grad_accumulation from launcher, split by DDP
    ...
    print0(f"micro_batch={B}, grad_accum_per_gpu={grad_accumulation_steps}, peak_lr={PEAK_LR}")
    ...
    # Simple optimizer - uniform LR, proven to work
    params = [p for p in raw_model.parameters() if p.requires_grad]
    optimizer = torch.optim.AdamW(
        params, lr=PEAK_LR, weight_decay=args.weight_decay, betas=(0.9, 0.95), fused=True
    )
    ...
    for step in range(args.num_iterations + 1):
        ...
        if args.val_loss_every > 0 and (step % args.val_loss_every == 0 or last_step):
            ...
            if is_final:
                # Swap in EMA weights for final evaluation
            ...
            if is_final:
                ...
                with torch.no_grad():
                    ...
                    raw_val_loss /= current_val_steps
                if raw_val_loss < val_loss:
