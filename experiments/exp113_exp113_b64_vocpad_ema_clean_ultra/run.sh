...
torchrun --standalone --nproc_per_node=1 experiments/exp113_exp113_b64_vocpad_ema_clean_ultra/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp113_exp113_b64_vocpad_ema_clean_ultra \
