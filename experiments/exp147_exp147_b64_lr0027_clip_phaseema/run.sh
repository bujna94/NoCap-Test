...
torchrun --standalone --nproc_per_node=1 experiments/exp147_exp147_b64_lr0027_clip_phaseema/train_gpt2.py \
  --input_bin "data/fineweb10B/fineweb_train_*.bin" \
  --input_val_bin "data/fineweb10B/fineweb_val_*.bin" \
  --output_dir experiments/exp147_exp147_b64_lr0027_clip_phaseema \
